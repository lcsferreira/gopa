    ...
    if($value == "approved"){
      ...
      foreach ($admin_emails as $email) {
        ...
        try{
          ...
          $mail->isHTML(true);
          $mail->Subject = "Translated Card Step - Contact completed";
          $mail->Body = "
          <br>
          Dear Admin,
          <br><br>
      ...
      foreach ($admin_emails as $email) {
        ...
        try{
          ...
          $mail->addAddress($email);
          $mail->isHTML(true);
          $mail->Subject = "Translated Card Step - Contact requested review";
          $mail->Body = "
          <br>
          Dear Admin,
          <br><br>
          ".$country_name." Contact has sended new information about the card translated step for the Country Cards 2024 Workflow on ".$date.". You may view their responses <a href='http://work.globalphysicalactivityobservatory.com/src/pages/login/login.php'>here</a>.
          <br><br>
          Please click in the <b>link below</b> to enter the 2024 GoPA! Country Cards Workflow.
          <br><br>
          <a href='http://work.globalphysicalactivityobservatory.com/src/pages/login/login.php'>Workflow</a>
