...
<?php
  ...
  $sql = "INSERT INTO countries (name, capital, region, indicators_step, translation_step, country_cards_step, need_translation) VALUES (?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($connection, $sql);

  mysqli_stmt_bind_param($stmt, "sssssss", $name, $capital, $region, $indicators_step, $translation_step, $country_cards_step, $need_translation);
