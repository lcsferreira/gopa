    ...
    <form>
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="name-1" id="name-1-admin">
        </div>
        <div class="form-input">
          <label for="name-1">
            Name 1
        ...
        <textarea placeholder="Add a comment..." name="comments" id="name-1-comments" cols="30" rows="5"
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="email-1" id="email-1-admin">
        </div>
        <div class="form-input">
          <label for="email-1">
            Email 1
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="institution-1" id="institution-1-admin">
        </div>
        <div class="form-input">
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="name-2" id="name-2-admin">
        </div>
        <div class="form-input">
          <label for="name-2">
            Name 2
        ...
        <textarea placeholder="Add a comment..." name="comments" id="name-2-comments" cols="30" rows="5"
          class="comment"></textarea>
      </div>
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="email-2" id="email-2-admin">
        </div>
        <div class="form-input">
          <label for="email-2">
            Email 2
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="institution-2" id="institution-2-admin">
        </div>
        <div class="form-input">
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="name-3" id="name-3-admin">
        </div>
        <div class="form-input">
          <label for="name-3">
            Name 3
        ...
        <textarea placeholder="Add a comment..." name="comments" id="name-3-comments" cols="30" rows="5"
          class="comment"></textarea>
      </div>
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="email-3" id="email-3-admin">
        </div>
        <div class="form-input">
          <label for="email-3">
            Email 3
      ...
      <div class="indicators">
        <div class="form-input">
          ...
          <input type="number" name="institution-3" id="institution-3-admin">
        </div>
        <div class="form-input">
