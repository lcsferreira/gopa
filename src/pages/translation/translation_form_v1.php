    ...
    if ($result->num_rows > 0) {
        ...
        if(isset($_POST['submit']))
        {
    	    $sql = "insert into translations values (".$country_id.", 0, '".
                                            ...
                                            $_POST['s41']."','".$_POST['s42']."','".$_POST['s43']."','".$_POST['s44']."','".$_POST['s45'].
                                            "')";
    ...
    $has_data = true;
        ...
        <div class="container">
            <div class="title mt-50">
                <h1>Translation</h1>
                <p>Please translate the following phrases/words on the input fields to your country's native language</p>
            </div>
