<html>
    ...
    if ($result->num_rows > 0) {
        if(isset($_POST['submit']))
        {
            ...
            if($affectedRows == 1)  echo "Translation has been updated successfully.";
        }
    }
    else { 
        if(isset($_POST['submit']))
        {
            ...
            $rs = mysqli_query($connection, $sql);
	        $affectedRows = mysqli_affected_rows($connection);
            if($affectedRows == 1) echo "Translation has been saved successfully.";
        }
    }
    $sql = "SELECT * FROM translations WHERE country_id = ".$country_id;
    $result = $connection->query($sql);
    ...
    $has_data = true;
        ...
        <?php if ($user != 0) echo "<input type=\"submit\" name=\"submit\" value=\"Submit\">";?>
        </form>
    </body>
  </html>