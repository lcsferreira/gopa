...
<body>
  <div class="container" id="main">
    <div class="title mt-50 h-600">
      ...
      <p>The Translated version of the Country Card will be displayed in this step. You can approve it or request additional changes, upload a file to offer more information, and leave a comment sharing your opinion.</p>
    </div>
    ...
    <div class="buttons">
        ...
        <button class="btn-next" type="button" <?php
          echo "onclick='document.location = `cardUploadTranslated.php?id=".$country_id."`'";
          ?> >Start</button>
      </div>
  </div>
