  ...
  <div class="container" id="main">
    ...
    <div class="forms-container">
      <form id="form" action="ajaxUpload.php" method="post" enctype="multipart/form-data">
        ...
        <div id="preview"></div>
        <br>
        <a class="btn-confirm btn-download" href="https://work.globalphysicalactivityobservatory.com/uploads/card_english/<?php echo $country_id?>.pdf" download="country_card_en"><i class="fa fa-download"></i> Download</a>
      </form>
      ...
      <form id="form-contact" action="cardUploadContact.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-checkbox">
          <div>
            ...
            <input type='radio' name='status' id='status' value='adjust' <?php if ($_SESSION["userType"] == "admin") {
            echo " disabled";
          }?>> 
          </div>
          <div>
            <label for='status'>Approve the Country Card</label>
            <input type='radio' name='status' id='status' value='approve' <?php if ($_SESSION["userType"] == "admin") {
            echo " disabled";
          }?>> 
          </div>
        </div>
