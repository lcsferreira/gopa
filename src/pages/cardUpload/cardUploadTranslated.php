...
<?php
  ...
  if($row['country_cards_step'] == "not started"){
    $sql = "INSERT INTO cards (id) VALUES ($country_id)";
    mysqli_query($connection, $sql);
    $sql = "UPDATE countries SET country_cards_step = 'waiting admin' WHERE id = $country_id";
    mysqli_query($connection, $sql);
  }

  $sql = "SELECT * FROM cards WHERE id = $country_id";
  $result = mysqli_query($connection, $sql);
  $row = mysqli_fetch_assoc($result);
...
<head>
  ...
  <script src="../../js/cardUpload/cardUploadTranslated.js"></script>
...
<body>
  <div class="container" id="main">
    ...
    <div class="title mt-50">
      <h1>Country Card Translated Version</h1>
    </div>
    <div class="forms-container">
      <form id="form" action="ajaxUploadTranslated.php" method="post" enctype="multipart/form-data">
