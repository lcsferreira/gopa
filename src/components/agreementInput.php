<div class="form-input">
  <div class="radio-agreement" id="radio-group">
    ...
    <div>
      ...
      <label for="no"> The information provided is <b>not</b> up to date and should not be included in the new Country Card 2024. Therefore, I <b>wish to provide</b> the updated information that should be included in the new Country Card 2024.</label>
    </div>
  </div>
</div>